...
echo "\033[32;1mAuthor : AzzamCyber"
echo "\033[37;1mFeat: Mjk Cyber Team"
echo "\033[35;1mversion Tools: 2"
echo "\033[35;1mTeam : AZZAM CYBER TEAM"
echo "\033[33;1mKontak Me :  088991443519"
echo "\033[31;1mPlease For Subcribe Youtube:"
echo "\033[92mAzzamCyber" 
...
echo "[+]===============================================[+]"
echo "\033[32;1m"
read -p "@AzzamCyber->" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "AZZAM CYBER" | lolcat
php tp.php
fi
...
then
clear
toilet -f slant --gay "AZZAM CYBER"
php kfc.php
fi
...
then
clear
toilet -f mono12 -F gay "AZZAM CYBER"
php phd.php
fi
...
then
clear
toilet -f slant -F gay "AZZAM CYBER" 
...
then
clear
toilet -f standard -F gay "AZZAM CYBER" 
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "AZZAM CYBER" | lolcat
figlet -f slant AZZAM CYBER
echo "\033[37;1m"
...
then
clear
cowsay -f sheep.cow "AZZAM CYBER" | lolcat
figlet "AZZAM CYBER" | lolcat
sleep 1
cd
cd module
...
echo "\033[32;1mauthor: AZZAM CYBER"
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "AZZAM CYBER" 
figlet "AZZAM CYBER" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
then
clear
cowsay -f kiss.cow "B4J1N6Mr4N" | lolcat
figlet "AZZAM CYBER" | lolcat
sleep 1
apt update && apt upgrade
apt install git
...
then
clear
toilet -f big -F gay "AZZAM CYBER " | lolcat
sleep 1
...
then
clear
toilet -f big -F gay " AZZAM CYBER "
sleep 1
apt update && apt upgrade
apt install wget
mkdir ngrok
...
if [ $bro = 0 ] || [ $bro = 00 ]
then
echo "\033[32;1mMOJOKERTO CYBER TEAM"
sleep 1
